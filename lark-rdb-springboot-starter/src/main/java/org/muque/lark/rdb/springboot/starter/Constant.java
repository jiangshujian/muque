package org.muque.lark.rdb.springboot.starter;
...
public interface Constant {
	 ...
	 * 精确匹配切面
	 */
	public static final String DATASOURCE_POINTCUT_PATTERN = "target(org.muque.lark.rdb.repository.BaseRepository)";
	/**
	 * 数据源配置KEY
	 */
